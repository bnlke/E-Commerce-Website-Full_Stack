...
export default function MensBestSellers() {
  ...
  if (loading) {
    return (
      <ShoeLayout
        products={[]}
        title="Best Sellers"
        description="Loading our most-loved men's styles..."
        loading={loading}
        error={error}
      />
    );
  ...
  return (
    <ShoeLayout
      products={products}
      title="Best Sellers"
      description="Our most-loved men's styles including the Tree Runner, Tree Dasher 2, and Wool Runner Mizzle. Discover why these are our community favorites."
      loading={loading}
      error={error}
    />
  );
