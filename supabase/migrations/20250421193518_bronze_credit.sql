/*
  ...
  1. New Functions
    - `get_user_orders`: Retrieves all orders for the authenticated user
    - `get_order_by_id`: Retrieves a specific order by ID with detailed information
  ...
  3. Features
    - Returns orders with related items and product details
