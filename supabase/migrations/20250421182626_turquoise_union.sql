/*
  # Fix Email Template Functions
  
  1. Changes
    - Drop existing get_email_template function
    - Create new get_email_template function with correct return type
    - Update email templates with better HTML content
